...
import { getProjectsPageCopy, getProjectsPageItems } from "../copy";

export function ProjectsListSection({ locale }: { locale: string }) {
    const copy = getProjectsPageCopy(locale);
    const projects = getProjectsPageItems(locale);
                ...
                {projects.map((project) => (
                    ...
                    >
                        ...
                        <div className="reveal w-full space-y-6 md:w-1/2">
                            <h4 className="text-4xl font-bold text-gray-900">{project.title}</h4>
