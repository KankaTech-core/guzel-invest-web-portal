        ...
        <main className="overflow-x-hidden bg-white pt-16 pb-20">
            <section className="relative isolate min-h-[430px] overflow-hidden bg-gray-900 sm:min-h-[520px]">
                ...
                <div className="container-custom relative z-10 flex min-h-[430px] flex-col items-center justify-center text-center sm:min-h-[520px]">
                    <span className="inline-flex items-center rounded-full border border-orange-300/65 bg-orange-500/20 px-4 py-1.5 text-[11px] font-semibold uppercase tracking-[0.15em] text-orange-100">
                        Güzel Invest • 2001&apos;den beri
                    </span>
                    <h1 className="mt-5 text-5xl font-bold text-white sm:text-6xl">Hakkımızda</h1>
            ...
            <section className="border-b border-gray-100 bg-white px-4 py-10 sm:px-6">
                <div className="mx-auto max-w-7xl">
                    <h2 className="text-center text-[11px] font-semibold uppercase tracking-[0.15em] text-orange-500">
                        İstatistikler
                    </h2>
                    <div className="mt-8 grid grid-cols-2 gap-y-8 md:grid-cols-5 md:gap-y-0">
                        {stats.map((stat, index) => (
                            <article
                                key={stat.label}
                                className={`flex flex-col items-center px-3 text-center ${index === stats.length - 1 ? "col-span-2 md:col-span-1" : ""} ${index < stats.length - 1 ? "md:border-r md:border-gray-100" : ""}`}
                            >
            ...
            <section id="hikayemiz" className="relative isolate scroll-mt-28 overflow-hidden bg-white px-4 py-16 sm:px-6">
            ...
            <section id="neler-yapiyoruz" className="relative isolate scroll-mt-28 overflow-hidden bg-white py-16">
                ...
                <div className="space-y-0">
                    {serviceDetails.map((service, index) => {
                        ...
                        return (
                            ...
                            >
                                <div className="container-custom grid grid-cols-1 items-center gap-8 py-14 lg:grid-cols-12 lg:gap-10">
            ...
            <section id="ekibimiz" className="relative isolate scroll-mt-28 overflow-hidden bg-white px-4 py-16 sm:px-6">
                ...
                <div className="mx-auto max-w-7xl">
                    ...
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        {teamMembers.map((member) => (
                            <article
                                key={member.name}
                                className="group overflow-hidden rounded-xl border border-gray-100 bg-white transition-all duration-300 hover:border-orange-200 hover:shadow-xl hover:shadow-orange-500/5"
                            >
            ...
            <section className="relative isolate overflow-hidden bg-white px-4 py-10 sm:px-6">
                ...
                <div className="mx-auto max-w-7xl space-y-10">
                    {principles.map((item) => (
                        ...
                        >
                            <article
                                className={`lg:col-span-7 ${item.reverse ? "lg:order-2" : ""}`}
                            >
                            ...
                            <div className={`lg:col-span-5 ${item.reverse ? "lg:order-1" : ""}`}>
                                <div className="overflow-hidden rounded-2xl border border-gray-200 bg-gray-100">
                                    <img
                                        src={item.image}
                                        alt={item.title}
            ...
            <section className="px-4 pt-4 pb-16 sm:px-6">
                <div className="mx-auto max-w-7xl overflow-hidden rounded-[28px] bg-gray-900">
                    <div
