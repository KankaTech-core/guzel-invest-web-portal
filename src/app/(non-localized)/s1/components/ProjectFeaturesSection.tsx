                ...
                <div className="mx-auto mt-12 flex flex-wrap justify-center gap-x-4 gap-y-14 sm:gap-x-8 sm:gap-y-16 lg:gap-x-10 lg:gap-y-20">
                    {items.map((item, idx) => (
                        <div
                            ...
                            className="group relative flex min-h-[160px] w-[calc((100%-1rem)/2)] flex-col items-center justify-center rounded-xl bg-gray-50 px-6 pb-8 pt-16 transition-colors hover:bg-gray-100 sm:w-[calc((100%-2rem)/2)] lg:w-[calc((100%-7.5rem)/4)]"
                        >
