...
export default async function SingleProjectPageS1({ searchParams }: PageProps) {
    ...
    return (
        <SPLayout>
            <main className="min-h-screen bg-white font-sans text-gray-900 selection:bg-orange-500/30">
