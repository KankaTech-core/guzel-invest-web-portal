...
export default async function AdminDashboard() {
    ...
    // Get stats
    const [listingsCount, usersCount, publishedCount, draftCount, recentListings] = await Promise.all([
                    ...
                    {recentListings.length === 0 ? (
                        ...
                        recentListings.map((listing) => (
                            <Link
                                ...
                                className="block focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-500/60 rounded-lg"
                            >
